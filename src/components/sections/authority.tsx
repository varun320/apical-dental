...
export function Authority() {
  return (
    <section className="relative border-t border-apical-border bg-surface px-6 py-28 lg:py-36 lg:px-10 overflow-hidden">
      <div className="pointer-events-none absolute -bottom-40 -left-40 h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(0,212,200,0.04),transparent_70%)]" />
      <div className="pointer-events-none absolute top-0 right-0 h-px w-[300px] bg-[linear-gradient(to_left,rgba(0,212,200,0.15),transparent)]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1100px]">
        ...
        {/* Bento Grid — spans applied directly, BlurFade wraps inner content */}
        <div className="mt-16 grid grid-cols-1 gap-5 md:grid-cols-4">
          ...
          {stats.map((cred, i) => (
            <div key={cred.label}>
              <BlurFade delay={0.15 + i * 0.08} inView>
                <div className="h-full rounded-xl border border-apical-border bg-void p-7 flex flex-col justify-center shadow-[0_2px_20px_rgba(0,0,0,0.3)]">
                  <div className="font-display text-[44px] font-[800] leading-none tracking-[-1.5px]">
          ...
          {/* IMU Technology — 2 cols */}
          <div className="md:col-span-2">
            <BlurFade delay={0.55} inView>
              <div className="relative overflow-hidden rounded-xl border border-apical-border bg-void p-8 shadow-[0_2px_20px_rgba(0,0,0,0.3)]">
